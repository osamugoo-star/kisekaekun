...
- 2026-06-07: Kisekaekun_free_Ver1.2
              ...
              ④【レイアウト修正】スマホ実機テスト時にプレビュー画像が横長に潰れる不具合をクリア。
              無理な高さ固定を廃止し、写真本来のアスペクト比を100%維持して最上部に美しく表示する仕様へ洗練。
...
# --- 🛠️ レイアウトの出し分け ＆ データ入力 ---
if is_mobile:
    # 【スマホ版】潰れを防ぐためCSS固定を廃止。最上部に「綺麗に比率が維持される空箱」を用意！
...
if uploaded_master is not None:
    ...
    if is_mobile:
        # スマホ時は、一番上の空箱に本来の比率（use_container_width）でドーンと綺麗に表示！
